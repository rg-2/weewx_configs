...
sudo cp index_hook_after_wind_table.inc /etc/weewx/skins/Belchertown/index_hook_after_wind_table.inc
...
sudo chown root:weewx /etc/weewx/skins/Belchertown/index_hook_after_wind_table.inc
